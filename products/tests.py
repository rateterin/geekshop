...
class TestProductsProductModelMethods(TestCase):
    def setUp(self) -> None:
        ...
        self.product_1 = Product.objects.create(category=self.category_1,
                                                name='Product_1',
                                                quantity=1,
                                                price=1000)
        self.product_2 = Product.objects.create(category=self.category_1,
                                                name='Product_2',
                                                quantity=1,
                                                price=1000)
        self.product_3 = Product.objects.create(category=self.category_1,
                                                name='Product_3',
                                                quantity=1,
                                                price=1000,
                                                is_active=False)
