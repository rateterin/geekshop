...
class TestBasketModelMethods(TestCase):
    ...
    def test_basket_print(self):
        self.assertEqual(str(self.basket_1), f'Корзина для tarantino | Продукт Product_1')
        self.assertEqual(str(self.basket_2), f'Корзина для tarantino | Продукт Product_2')
